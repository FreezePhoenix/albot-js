...
let monster_targets = ["wolf"],
	state = "farm",
	group = ["Boismon","Firenus", "Geoffrey", "Daedulaus", "AriaHarper"], // The group our character operates in. This generally forms a chain.
...
let to_send = new Set(["candycane", "mistletoe", "funtoken", "seashell", "gem0", "gem1", "wbook0", "intbelt", "strbelt", "dexbelt", "intearring", "dexearring", "intamulet", "dexamulet", "intring", "dexring", "bugbountybox"]);
/*
setInterval(() => {
...
function farm() {
	...
	if (character.ctype != "merchant") {
		...
		if (attack_target != null) {
			...
			if (!smart.moving && !character.rip && !tree) {
				if(monster_targets[0] == "wolfie") {
					smart_move({ x: 350, y:-2315, map: "winterland"});
				} else {
...
let avoidMobs = (function () {
	...
	var avoidTypes = ["mole", "poisio", "bigbird", "crabx", "rudolph"];
