			...
			switch (type) {
				case 'text':
					html +=
						"<div class='" +
						name +
						" textDisplay boxRow'><div class='textDisplayLabel'>" +
						label +
						": </div><div class='textDisplayValue'></div></div>";
					break;
				case 'progressBar':
					if (!options)
						options = {
					...
					html +=
						"<div class='" +
						name +
						" progressBarDisplay boxRow'><div class='border'><div class='barLabel'>" +
						label +
						": <div class='odometer value'>0%</div></div><div class='bar' style='background-color: " +
						options.color +
						"'> </div></div>  </div>";
					break;
				case 'image':
					...
					html +=
						"<div class='" +
						name +
						" imageDisplay boxRow'> <img src='' style='width:" +
						options.width +
						'px;height:' +
						options.height +
						"px;'/> </div>";
				...
				case 'breakdownBar':
					...
					html +=
						"<div class='" +
						name +
						" progressBarDisplay boxRow'><div class='border'>";
					html +=
						"<div class='barLabel'>" +
						label +
						": <div class='odometer value'>0</div></div>";
			...
			switch (type) {
				...
				case 'progressBar':
					row.getElementsByClassName('bar')[0].style.width =
						value + '%';
					row.getElementsByClassName('value')[0].textContent =
						value + '%';
					break;
				case 'image':
