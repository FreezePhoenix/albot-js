...
( // Module boilerplate to support browser globals and browserify and AMD.
    ...
    function decode(buffer, offset, start, end) {
        var view = new DataView(buffer, start, end);
        var decoder = new Decoder(view, offset);
        var value = decoder.parse();
        if (decoder.offset !== view.byteLength) {
            console.log(buffer);
            console.log("vuew", view);
            throw new Error((view.byteLength - decoder.offset) + " trailing bytes");
        }
        return value;
    }
